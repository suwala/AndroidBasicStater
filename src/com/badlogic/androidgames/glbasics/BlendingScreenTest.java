...
public class BlendingScreenTest extends GLGame{
	...
	class BlendingScreen extends Screen{
		...
		public BlendingScreen(Game game) {
			...
			textureRgb = new Texture((GLGame)game,"dir/texture/reimu888.png");
			textureRgba = new Texture((GLGame)game,"dir/texture/reimu8888.png");
